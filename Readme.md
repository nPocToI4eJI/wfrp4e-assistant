...
- _Настройка:_
  ...
  - В поле параметров укажите необходимые через запятую. Список и краткое описание доступных параметров для выбранного Народа можно увидеть, наведя поле.
...
- _Принцип работы:_
  - При снижении параметра ран актёра до 0, его токен (или все его токены) окрашиваются в указанный цвет.
